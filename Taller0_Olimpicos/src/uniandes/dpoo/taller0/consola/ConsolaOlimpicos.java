...
{
	// C:\Users\SGM\eclipse-workspace\Taller0_Olimpicos\data\atletas.csv
	/**
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país al que pertenece un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le pide al usuario el nombre de un atleta
	 * Muestra al usuario el nombre del país al que representa el atleta
	 */
	 private void ejecutarPaisAtleta()
	 {
		System.out.println("\nPaís al cual representa el atleta\n");
		
		String nombreAtleta = null;
		try
		{
			System.out.print("Por favor ingrese el nombre del atleta: ");

			BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
			nombreAtleta = reader.readLine();
		}
		catch (IOException e)
		{
		...
		if (paisAtleta != null)
		{
			System.out.println("\nEl país del atleta " + nombreAtleta + " es " + paisAtleta);
		}
		else
		{
			System.out.println("\nNo se ha encontrado el atleta. Por favor digite un nombre válido.");
		}
	 }
